         ...
         kinematics_msgs::GetPositionIK::Response &res )
{
	...
	ChainIkSolverPos_NR_JL iksolverpos(chain, q_min, q_max, fksolver1,iksolver1v,1000,1e-2);//Maximum 100 iterations, stop at accuracy 1e-6
...
{
	ros::init(argc, argv, "kuka_ik_solver");
	ros::NodeHandle n;
	KDL::Tree my_tree;
	ros::NodeHandle node;
