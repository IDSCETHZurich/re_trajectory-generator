...
public:
  ...
  */
  pr2_controllers_msgs::JointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.points[ind].positions[0] = 0.0;
    goal.trajectory.points[ind].positions[1] = 3.1;
    goal.trajectory.points[ind].positions[2] = 0.0;
    goal.trajectory.points[ind].positions[3] = -2.6;
    goal.trajectory.points[ind].positions[4] = -2.4;
    goal.trajectory.points[ind].positions[5] = 0.0;
    goal.trajectory.points[ind].positions[6] = 0.0;
...
int main(int argc, char** argv)
{
  ...
  ROS_INFO("Starting trajectory action ..");
  arm.startTrajectory(arm.armExtensionTrajectory());
  arm.traj_client_->waitForResult();
  ROS_INFO("simple_trajectory.cpp: trajectory execution finished");
 
  ROS_INFO("state:%s", (arm.traj_client_->getState()).toString().c_str());
